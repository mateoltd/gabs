...
test("administrators manage role tags with matching matrix and module review decisions", async ({
  page,
}) => {
  await page.goto("/");
  await page
  ...
  await roleTagsJourney(page, await createReviewWorkspace(send), send);
});
