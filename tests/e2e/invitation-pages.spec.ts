...
test("administrators browse and search all invitations with accurate summaries", async ({
  page,
}) => {
  await page.goto("/");
  await page
  ...
  await invitationPagesJourney(page, await createReviewWorkspace(send), send);
});
