  ...
  try {
    ...
    for (const input of sortData) {
      const saved = await page.evaluate(
        ...
        { workspaceId, moduleId: sortId, input },
      );
    ...
    await page
      .getByRole("heading", { name: "Sorted records", exact: true })
      .scrollIntoViewIfNeeded();
    await page.screenshot({
      path: "docs/verification/resource-sort/electron.png",
    });
    expect(
      await page.evaluate(
