  ...
  try {
    ...
    for (const input of rangeData) {
      const saved = await page.evaluate(
        ...
        { workspaceId, moduleId: rangeId, input },
      );
    ...
    await page
      .getByRole("heading", { name: "Range records", exact: true })
      .scrollIntoViewIfNeeded();
    await page.screenshot({
      path: "docs/verification/resource-ranges/electron.png",
    });
    expect(
      await page.evaluate(
