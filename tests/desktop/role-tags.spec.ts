...
import { roleTagsJourney } from "../support/role-tags-journey";
...
test("hidden native administrators manage role tags through the shared policy service", async () => {
  ...
  try {
    ...
    await roleTagsJourney(page, await createReviewWorkspace(send), send, true);
    expect(
