...
import { crossCaptureJourney } from "../support/cross-capture-journey";
...
test("native nested cross-module capture survives offline restart and recovers revoked grants", async () => {
...
globalThis.fetch=async(...args)=>{
 ...
 const create=String(args[0]).endsWith('/records')&&body?.action==='create';
