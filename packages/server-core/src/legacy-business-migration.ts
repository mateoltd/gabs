...
import { migrateModuleStorageBatch } from "./module-migrations";
...
import { audit, iso, publish } from "./transactions";
...
async function convert(
  ...
  for (const id of moduleIds) source.set(id, await workspaceModule(tx, ws, id));
