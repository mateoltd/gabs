...
- Uncommitted-outcome fencing now has separate browser/native evidence in that milestone. [Held-action authority](../command-authority/README.md) adds lease expiry and received revocation. [Command upgrade acceptance](../command-upgrade/README.md) now covers changed permission declarations and a new required input field. Removed/reclassified commands, historical-grant administration, further release transitions and profile/sign-out recovery remain required.
