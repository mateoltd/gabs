...
[Run 35128117193](https://github.com/mateoltd/gabs/actions/runs/35128117193) (`9ea4364`) passed functional/build, browser, three unsigned desktop packaging jobs and logical restore. Read/confirmation p95 was **725/747 ms** on AMD EPYC 9V74 with two cores, against unchanged **500/1000 ms** targets. OPS-07 remains open for failed read acceptance. This verifies the business-screen adapter checkpoint and predates administrator cutover. Log: `/tmp/gabs-ci-35128117193-failed.log`.

[Run 35130858941](https://github.com/mateoltd/gabs/actions/runs/35130858941) (`2bde7ab`) passed functional/build, browser, three unsigned packaging jobs and restore, but measured 598/630 ms on an Intel Xeon Platinum 8370C runner with two cores. Read acceptance still failed. The subsequent [scoped-default milestone](../../business-defaults/README.md) changes the measured implementation to the public SDK and narrows registry metadata to the dependency closure. Its local improvement does not supersede the remote acceptance requirement.
