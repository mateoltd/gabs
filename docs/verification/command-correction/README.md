...
- [Held-action authority](../command-authority/README.md) now verifies real-client lease expiry and received revocation during delayed settlement replies. [Command upgrade acceptance](../command-upgrade/README.md) adds original/installed permission declarations and a new required input field in real clients. Removed/reclassified commands, historical-grant administration, further schema transitions and profile/sign-out recovery remain required.
