...
GOV-01 remains active for chart classification filters/autocomplete and broader employee/group administration. The subsequent [unavailable-release recovery](../module-release-recovery/README.md) covers permission-catalog edits, suspension and independent pin repairs; this earlier review covers edits whose requested permissions were already held. Signature/trust-key corruption recovery remains a separate operational gate. Large organizations, actual provider events, signed target-platform releases and broader rollout/recovery acceptance remain separate gates. Full parity and the later UI-refinement goal remain open.
