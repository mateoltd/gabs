...
Follow-up: [installation-time reference consent](../local-migration-grants/README.md) now covers the prospective migration grants listed as open in this earlier checkpoint. The remaining local services, device capabilities and corporate offline requirements are unchanged.
