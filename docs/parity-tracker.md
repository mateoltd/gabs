...
- **Active:** OPS-07, profiling and resolving the remote CI latency failure with the existing budgets. EXT-04 is verified locally: durable exact-release attempts, server receipts, interrupted install/update/removal recovery, safe pins, bounded executable storage and real web/native restart journeys. [Lifecycle evidence](verification/module-recovery/README.md).
