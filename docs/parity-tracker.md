...
- **Verification:** [Typed resource sorting](verification/resource-sort/README.md) passed 216 unit/PostgreSQL tests on a fresh database, strict checks/four builds, 12 distinct headless browser journeys across focused runs and two distinct hidden/unfocused native journeys. Final corrections passed nine browser journeys plus a native rerun; the local screenshot/reset assertion passed a final focused rerun. Nine captures were inspected, with scoped Axe and narrow no-overflow checks. Historical screenshots and shared development data were preserved. Previous `0f05b97` / [CI 35179410609](https://github.com/mateoltd/gabs/actions/runs/35179410609) completed with five browser failures, now corrected locally; load/restore were skipped, and uploads failed at account quota. Latest completed `39a9b37` / [CI 35180810161](https://github.com/mateoltd/gabs/actions/runs/35180810161) likewise passed 212 unit tests and 90 browser cases but failed those same five cases, skipped load/restore and hit upload quota. The new `d0cb974` / [CI 35182720028](https://github.com/mateoltd/gabs/actions/runs/35182720028) started no jobs because the Actions budget prevents further use. Continue local SDK work; remote acceptance, OPS-07, full parity and final UI approval remain open.
