...
- **Last verified baseline:** 76 unit/PostgreSQL tests, 19 distinct focused Chromium journeys, all six Electron journeys, four builds and formatting. The browser proves actual response loss and receipt recovery after a mandatory update; the native bridge also recovers an original receipt and refuses new old-version work. [Current evidence and limits](verification/receipt-recovery/README.md).
