...
- **In parallel:** OPS-07 remains open. Remote `35119858250` / `891fd14` passed functional/build, all browser journeys, three unsigned packaging jobs and restore, but measured 653/675 ms p95 for read/confirmation against unchanged 500/1000 ms limits. [Evidence](verification/performance/authorization/README.md).
