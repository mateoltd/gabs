...
- **Next:** SDK-03: custom React development previews, module-owned scenarios and cross-module fixtures. SDK-04/SDK-05 retain their full authoring/UI/capability scope. OPS-07 continues in parallel; no external dependency blocks the next engineering item.
