...
- **Verification:** [Public reference clients](verification/reference-client/README.md) passed 194 unit/PostgreSQL tests, a final 11-case cancellation/reference/worker pass, strict checks/four builds, five distinct headless journeys and two hidden/unfocused Electron journeys. Scoped Axe and four new captures were inspected; historical screenshots were preserved. Remote `7401f8d` / [CI 35170982721](https://github.com/mateoltd/gabs/actions/runs/35170982721) passed all 189 unit tests, all 85 browser cases, code/build, three unsigned packages and a two-second logical restore. The run failed unchanged load budgets at 891/1,821 ms; OPS-07 remains open. These remote results verify the preceding migration checkpoint, not the new reference-client changes. Full parity and final UI approval remain open.
