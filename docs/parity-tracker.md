...
| GitHub Actions execution budget                                                   | OPS-04, OPS-05, OPS-07 | `d0cb974` / CI `35182720028` started no jobs: the account Actions budget prevents further use. Continue local engineering and acceptance; rerun this checkpoint after authorized account capacity is restored.       |
