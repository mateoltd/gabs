...
- **Active:** SDK-04. [Typed structured form milestone](verification/schema-forms/README.md) adds public draft/validation helpers, recursive host editors and typed custom-view composition. The form milestone passed 25 focused tests, strict checks/four builds, 21 distinct headless journeys across correction runs and four minimized native journeys. Schema-derived documentation generation, generated tables/filtering/pagination, recursive reference lookup and complete composability remain in scope; SDK-04 is not complete.
