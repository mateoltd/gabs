...
- **Completed locally:** SDK-03. [Cross-module fixtures and provider development](verification/module-services-preview/README.md) complete the scoped acceptance map for typed module-owned scenarios, custom React preview, source/fixture reload and permission/offline simulation. SDK-04 is next for schema-derived documentation/UI/composability; SDK-05 remains open. First investigate the prior remote device-report regression described below. No external dependency blocks this engineering work.
