import { Pool } from "pg";
import { seedRegistry } from "../modules/seed-registry";
...
import {
  ...
  authorize,
  assignModules,
} from "@suite/module-catalog/server-product";
...
import inventory from "@suite/inventory";
import orders from "@suite/orders";
